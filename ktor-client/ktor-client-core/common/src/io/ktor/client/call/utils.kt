 ...
 */
@Deprecated(
    "Unbound [HttpClientCall] is deprecated. Consider using [HttpResponse] instead.",
...
@Deprecated(
    "Unbound [HttpClientCall] is deprecated. Consider using [HttpResponse] instead.",
    level = DeprecationLevel.ERROR,
    replaceWith = ReplaceWith("this.request<HttpResponse>(urlString, block)", "io.ktor.client.statement.*")
)
