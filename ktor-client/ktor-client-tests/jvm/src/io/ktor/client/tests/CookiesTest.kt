...
abstract class CookiesTest(private val factory: HttpClientEngineFactory<*>) : TestWithKtor() {
    ...
    @Test
    fun testAccept(): Unit = testWithEngine(factory) {
        config {
            install(HttpCookies)
        }
    ...
    @Test
    fun testUpdate(): Unit = testWithEngine(factory) {
        config {
            install(HttpCookies) {
                default {
                    runBlocking {
    ...
    @Test
    fun testExpiration(): Unit = testWithEngine(factory) {
        config {
            install(HttpCookies) {
                default {
                    runBlocking {
    ...
    @Test
    fun testConstant(): Unit = testWithEngine(factory) {
        config {
            install(HttpCookies) {
    ...
    @Test
    fun testMultipleCookies(): Unit = testWithEngine(factory) {
        config {
            install(HttpCookies) {
                default {
                    runBlocking {
